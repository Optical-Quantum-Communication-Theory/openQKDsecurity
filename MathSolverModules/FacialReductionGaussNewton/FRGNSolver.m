...
optionsParser.addOptionalParam("maxIter",10, ...
    @isscalar, ...
    @mustBePositive, ...
    @(x)mustBeInteger(x));
optionsParser.addOptionalParam("toleranceGN", 1e-9, ...
    @isscalar, ...
    @mustBeNonnegative);
optionsParser.addOptionalParam("toleranceFR", 1e-12, ...
    @isscalar, ...
    @mustBeNonnegative);
optionsParser.addOptionalParam("toleranceLiCols", 1e-9, ...
    @isscalar, ...
    @mustBePostive);
