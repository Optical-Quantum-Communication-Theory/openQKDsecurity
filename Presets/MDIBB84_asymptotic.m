...
function [protocolDescription,channelModel,leakageEC,parameters,solverOptions] = MDIBB84Lossy_asymptotic()
...
%     parameters.scan.thetaA = 0 %0:pi/32:pi/2; %misalignment angle between Alice-Charlie
    parameters.scan.eta = 10.^(0:0.5:0); %channel transmittance between Alice-Charlie (half of total distance)
