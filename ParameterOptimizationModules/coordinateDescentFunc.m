...
optionsParser.addOptionalParam("maxIterations",3,@mustBeInteger);
optionsParser.addAdditionalConstraint(@(x)mustBeGreaterThanOrEqual(x,1),"maxIterations");

optionsParser.addOptionalParam("linearResolution",6,@mustBeInteger);
optionsParser.addAdditionalConstraint(@(x)mustBeGreaterThanOrEqual(x,1),"linearResolution");

optionsParser.addOptionalParam("iterationTolerance",1e-6,@(x)mustBeGreaterThanOrEqual(x,0));
