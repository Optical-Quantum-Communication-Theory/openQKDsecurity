...
% transmission. For qubits, depolarization corresponds to a shrinking of
% the state on the Bloch sphere. With 0 depolarization a pure state remains
% on the surface of the Bloch sphere. A completely depolarized state
...
channelModule = QKDChannelModule(@BasicBB84Alice4DChannelFunc);
